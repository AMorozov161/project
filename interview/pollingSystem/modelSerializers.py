...
class AnswerSerializer(serializers.ModelSerializer):
    ...
    poll = serializers.SlugRelatedField(queryset=PollingSys.objects.all(), slug_field='id')
...
class ChoiceSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        try:
            object = Choice.objects.get(question=attrs['question'].id, choice_text=attrs['choice_text'])
...
class PollSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        return PollingSys.objects.create(**validated_data)
